<template>
    <div>
        <div
            ...
            <div
                class="flex flex-wrap md:text-left text-center order-first">
                <div
                    ...
                    <nav
                        ...
                        <li><a
                                class="text-gray-600 hover:text-gray-800">ลิงค์แรก</a>
                        </li>
                        <li><a
                                class="text-gray-600 hover:text-gray-800">ลิงค์ที่สอง</a>
                        </li>
                        <li><a
                                class="text-gray-600 hover:text-gray-800">ลิงค์ที่สาม</a>
                        </li>
                        <li><a
                                class="text-gray-600 hover:text-gray-800">ลิงค์ที่สี่</a>
                        </li>
                    </nav>
                </div>
                <div
                ...
                <div
                    ...
                    <div
                        ...
                        <div
                            ...
                            <label
                                for="footer-field"
                                class="leading-7 text-sm text-gray-600">ตัวยึดตำแหน่ง</label>
                            <input
                                type="text"
                                id="footer-field"
                                name="footer-field"
                    ...
                    <p
                        class="text-gray-500 text-sm mt-2 md:text-left text-center">
                        Bitters
                        chicharrones
                        แฟนนี่แพ็ค<br
                            class="lg:block hidden">เสื้อกั๊กน้ำผลไม้สีเขียว
                    </p>
                </div>
            </div>
        </div>
    ...
    <footer
        class="text-gray-600 body-font sticky bottom-0 fixed">
        <div class="bg-gray-100">
            <div
                ...
                <a
                    ...
                    <span
                        class="ml-3 text-xl">บล็อคท้ายรถ</span>
                </a>
                <p
                    class="text-sm text-gray-500 sm:ml-6 sm:mt-0 mt-4">
                    © 2020 Tailblocks —
