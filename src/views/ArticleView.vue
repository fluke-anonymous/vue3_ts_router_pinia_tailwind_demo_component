                ...
                <div
                    ...
                    <div
                        ...
                        <p
                            ...
                            poutine.</p>
                        <a
                            class="mt-3 text-indigo-500 inline-flex items-center">Learn
                            More
                            <svg fill="none"
                                stroke="currentColor"
                                stroke-linecap="round"
    ...
    <section
        ...
        <div
            ...
            <div class="flex flex-col">
                <div
                    class="h-1 bg-gray-200 rounded overflow-hidden">
                    <div
                        class="w-24 h-full bg-indigo-500">
                    </div>
                </div>
                <div
            ...
            <div
                ...
                <div
                    ...
                    <h2
                        class="text-xl font-medium title-font text-gray-900 mt-5">
                        Shooting Stars
                    </h2>
                    <p
                    ...
                    <a
                        class="text-indigo-500 inline-flex items-center mt-3">Learn
                        More
                        <svg fill="none"
                            stroke="currentColor"
                            stroke-linecap="round"
